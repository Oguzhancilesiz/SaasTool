        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RedeemBy = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    AppliesToAppId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppUserProfiles_Apps_AppId",
                        column: x => x.AppId,
                        principalTable: "Apps",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppUserProfiles_Organizations_OrganizationId",
                        column: x => x.OrganizationId,
                        principalTable: "Organizations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppPlans_Apps_AppId",
                        column: x => x.AppId,
                        principalTable: "Apps",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppPlans_Plans_PlanId",
                        column: x => x.PlanId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OveragesEnabled = table.Column<bool>(type: "bit", nullable: false),
                    OverageUnitPrice = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    Status = table.Column<int>(type: "int", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    AutoID = table.Column<int>(type: "int", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Provider = table.Column<int>(type: "int", nullable: false),
                    ProviderInvoiceId = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SubscriptionCoupons_Coupons_CouponId",
                        column: x => x.CouponId,
                        principalTable: "Coupons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SubscriptionCoupons_Subscriptions_SubscriptionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SubscriptionItems_Features_FeatureId",
                        column: x => x.FeatureId,
                        principalTable: "Features",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UsageRecords_Features_FeatureId",
                        column: x => x.FeatureId,
                        principalTable: "Features",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApiKeys_OrganizationId_AppId_KeyHash",
                table: "ApiKeys",
                columns: new[] { "OrganizationId", "AppId", "KeyHash" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AppPlans_AppId_PlanId",
                table: "AppPlans",
                columns: new[] { "AppId", "PlanId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AppPlans_PlanId",
                table: "AppPlans",
                column: "PlanId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppUserProfiles_AppId",
                table: "AppUserProfiles",
                column: "AppId");

            migrationBuilder.CreateIndex(
                name: "IX_AppUserProfiles_OrganizationId_AppId_UserId",
                table: "AppUserProfiles",
                columns: new[] { "OrganizationId", "AppId", "UserId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SubscriptionCoupons_CouponId",
                table: "SubscriptionCoupons",
                column: "CouponId");

            migrationBuilder.CreateIndex(
                name: "IX_SubscriptionCoupons_SubscriptionId_CouponId",
                table: "SubscriptionCoupons",
                columns: new[] { "SubscriptionId", "CouponId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_SubscriptionItems_FeatureId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Subscriptions_OrganizationId_AppId_SubscriptionState",
                table: "Subscriptions",
                columns: new[] { "OrganizationId", "AppId", "SubscriptionState" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UsageRecords_FeatureId",
                table: "UsageRecords",
                column: "FeatureId");

            migrationBuilder.CreateIndex(
                name: "IX_UsageRecords_SubscriptionId_FeatureId_PeriodStart_PeriodEnd",
                table: "UsageRecords",
                columns: new[] { "SubscriptionId", "FeatureId", "PeriodStart", "PeriodEnd" },
                unique: true);
